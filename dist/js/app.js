 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".portfolio-widget__slider")) new core(".portfolio-widget__slider", {
            ...
            if (document.querySelector(".news-widget__slider")) new core(".news-widget__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".licenses__slider")) {
                ...
                function clientsHandleMd2Change(e) {
                    if (e.matches) {
                        if (!init) {
                            init = true;
                            licenses = new core(".licenses__slider", {
...
***************************************************************************** */
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (window.innerWidth > 767.98) {
                if (targetElement.classList.contains("menu__arrow")) targetElement.closest(".menu-item").classList.toggle("_hover");
                if (!targetElement.closest(".menu-item") && document.querySelectorAll(".menu-item._hover").length > 0) removeClasses(document.querySelectorAll(".menu-item._hover"), "_hover");
            }
            if (window.innerWidth < 767.98) if (targetElement.classList.contains("menu__arrow")) {
        ...
        if (window.innerWidth < 767.98) {
            ...
            if (menuItemsHasChildren.length > 0) menuItemsHasChildren.forEach((element => {
        ...
        document.addEventListener("selectCallback", (function(e) {
            ...
            if (expertiseType) expertiseType.value = currentSelect.value;
            if (expertiseType) requestExpertiseType.value = currentSelect.value;
        }));
        ...
        if (connectionType) connectionOptions.forEach((element => {
        ...
        if (template1ServicesItems.length > 0) template1ServicesItems.forEach((element => {
